...
class Ui_UpdateWindow(object):
    def setupUi(self, MainWindow):
        ...
        collection_label.setGeometry(QRect(320, 335, 150, 30))
        ...
        self.update_api_button.setGeometry(QRect(310, 410, 280, 65))
        button_font = QFont()
        button_font.setFamily("Segoe UI")
        button_font.setPointSize(18)
        button_font.setBold(True)
        self.update_api_button.setFont(button_font)
        self.update_api_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.update_api_button.setStyleSheet("""
            QPushButton {
        ...
        self.menubar.setStyleSheet("background-color: #FF8C00; color: white;")
        MainWindow.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(MainWindow)
        self.statusbar.setObjectName(u"statusbar")
        self.statusbar.setStyleSheet("background-color: #FF8C00; color: white;")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Hospital Records System - Update", None))
